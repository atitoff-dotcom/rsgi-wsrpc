...
2. [Архитектура: Ядро + Плагины + Приложение](#-архитектура-ядро--плагины--приложение)
   * [Архитектура «для чайников» с псевдографикой (docs_ru/architecture_for_beginners.md)](docs_ru/architecture_for_beginners.md)
...
│   Асинхронный орм       Пользователи, JWT,     Потоковая 2PC-загрузка,  │
...
* Подробная архитектура: см. **[docs_ru/smart_cache.md](docs_ru/smart_cache.md)** и **[RFC 0001](rfc/0001-smart-cache.md)**.
...
* Подробное руководство: см. **[docs_ru/testing.md](docs_ru/testing.md)**.
